...
CREATE SEQUENCE kmdata.groups_old_id_seq;

CREATE TABLE kmdata.groups_old (
                id BIGINT NOT NULL DEFAULT nextval('kmdata.groups_old_id_seq'),
                CONSTRAINT groups_old_pk PRIMARY KEY (id)
);


ALTER SEQUENCE kmdata.groups_old_id_seq OWNED BY kmdata.groups_old.id;
...
CREATE TABLE kmdata.offering_meetings (
                id BIGINT NOT NULL,
                offering_id BIGINT NOT NULL,
                CONSTRAINT offering_meetings_pk PRIMARY KEY (id)
);
...
CREATE TABLE kmdata.offering_instructors (
                id BIGINT NOT NULL,
                offering_meeting_id BIGINT NOT NULL,
                user_id BIGINT NOT NULL,
                CONSTRAINT offering_instructors_pk PRIMARY KEY (id)
);
...
ALTER TABLE kmdata.offering_meetings ADD CONSTRAINT offerings_offering_meetings_fk
...
ALTER TABLE kmdata.offering_instructors ADD CONSTRAINT offering_meetings_offering_instructors_fk
FOREIGN KEY (offering_meeting_id)
REFERENCES kmdata.offering_meetings (id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
NOT DEFERRABLE;
...
ALTER TABLE kmdata.offering_instructors ADD CONSTRAINT users_offering_instructors_fk
FOREIGN KEY (user_id)
REFERENCES kmdata.users (id)
ON DELETE NO ACTION
ON UPDATE NO ACTION
