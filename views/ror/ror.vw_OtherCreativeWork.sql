CREATE OR REPLACE VIEW ror.vw_OtherCreativeWork AS 
 SELECT w.id, w.user_id AS person_id, w.author_list, w.format, w.forthcoming_id, w.percent_authorship, w.role_designator, 
