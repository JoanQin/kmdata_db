CREATE OR REPLACE VIEW ror.vw_BookChapter AS 
 SELECT w.id, w.user_id AS person_id, w.author_list, w.city, w.country, w.edition, w.editor_list, w.percent_authorship, 
        ...
        w.created_at, w.updated_at, w.isbn, w.lccn,
