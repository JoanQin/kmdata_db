...
ALTER TABLE ror.vw_CoursesTaughtOther
  OWNER TO kmdata;
GRANT ALL ON TABLE ror.vw_CoursesTaughtOther TO kmdata;
GRANT SELECT ON TABLE ror.vw_CoursesTaughtOther TO kmd_ror_app_user;
GRANT SELECT ON TABLE ror.vw_CoursesTaughtOther TO kmd_dev_riv_user;
--GRANT SELECT ON TABLE ror.vw_CoursesTaughtOther TO kmd_report_user;
