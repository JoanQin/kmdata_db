create or replace view vw_ClinicalInterest as 
select  a.id, a.narrative_type_id, a.narrative_text, a.private_ind, a.created_at,
	...
	kmd_dev_riv_user.getaamcmedicalspecialties(a.narrative_text) as medical_specialties
...
where na.narrative_desc = 'Clinical Interest'