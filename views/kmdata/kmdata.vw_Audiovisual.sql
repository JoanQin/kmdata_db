CREATE OR REPLACE VIEW kmdata.vw_Audiovisual AS 
   SELECT w.id, w.resource_id, w.user_id, w.city, w.country, w.director, w.distributor, 
        ...
        city, country, director, distributor, format,
	          artist, network, percent_authorship, role_designator, sponsor, state, 
	          broadcast_dmy_single_date_id,
	          presentation_dmy_range_date_id, sd2.month, sd2.year
	          title, url,  work_type_id, a.work_type_name,
	          completed, producer, sub_work_type_id, sub_work_type_other, e.name as audiovisual_work_name,
