CREATE OR REPLACE VIEW kmdata.vw_Unpublished AS 
 SELECT w.id, w.resource_id, w.user_id, w.title, w.author_list, w.percent_authorship, 
        ...
        title, author_list, completed,
	          percent_authorship, submission_dmy_single_date_id, 
	          review_type_id, f.name as review_type_name, work_type_id, a.work_type_name,
	          submitted_to, extended_author_list, status_id, e.name as publication_status,
