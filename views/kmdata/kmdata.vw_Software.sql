...
SELECT w.id, w.resource_id, w.user_id, w.author_list, w.sponsor, w.percent_authorship, w.publisher, w.role_designator, w.title, w.medium, w.url, w.edition, 
        ...
        w.created_at, w.updated_at, w.work_type_id, a.work_type_name, w.distributor, w.sub_work_type_id, b.name as type_of_work, w.sub_work_type_other,
        c.narrative_text, d.is_public        
   FROM kmdata.works w
