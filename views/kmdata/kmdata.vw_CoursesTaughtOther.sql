...
SELECT a.id, user_id, a.course_taught_other_type_id, title, "number", length, 
   ...
   times_offered, a.resource_id, created_at, updated_at,
   b.name as institution_name, c.name as academic_calendar_name, academic_calendar_other,
