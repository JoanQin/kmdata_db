CREATE OR REPLACE VIEW kmdata.vw_EditedBook AS 
 SELECT w.id, w.resource_id, w.user_id, w.author_list, w.editor_list, w.city, w.country, w.edition, w.percent_authorship, 
        ...
        w.author_list, w.editor_list, w.city, w.country, w.edition, w.percent_authorship, 
	          w.publication_dmy_single_date_id,
	          w.publisher, w.review_type_id, f.name as review_type_name, w.state, w.title, w.url, w.volume, w.work_type_id, a.work_type_name, w.is_review,
	           w.isbn, w.lccn,
	          w.status_id, e.name as publication_status, w.sub_work_type_id, h.name as edited_book_name,
