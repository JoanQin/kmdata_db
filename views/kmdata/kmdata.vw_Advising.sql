...
SELECT adv.id, adv.user_id, adv.institution_id, ins.name AS inst_name, ins.college_university_code, adv.advisee_type_id, adv.username, adv.first_name, 
       ...
       adv.description_of_effort, b.name as rolename, c.name as levelname, adv.ongoing, 
	case when adv.ongoing = '1' then 'Yes' when adv.ongoing = '0' then 'No' else null end as ongoing_ind,
