 ...
 SELECT a.id, a.resource_id, a.user_id, a.author_list, a.city, a.country, a.created_by, 
	a.creation_dmy_single_date_id, sd2.month, sd2.year, a.isbn, a.journal_title, a.original_publication_type,
         b.name as originaltype_val, a.beginning_page, a.ending_page, a.percent_authorship, a.publication_type_id, 
         c.name as type_val, a.publication_dmy_single_date_id, sd.month, sd.year, a.publisher, a.state, a.title, a.publication_title,  
