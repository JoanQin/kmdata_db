...
SELECT w.id, w.resource_id, w.user_id, w.enacted, c.name as enacted_val, w.enacted_on_dmy_single_date_id, sd1.month, sd1.year,
	w.issuing_organization, w.legal_number, w.percent_authorship, w.role_id, e.name as role_val, w.role_designator, w.sponsor,
	w.submission_dmy_single_date_id, sd2.month, sd2.year, w.submitted_to, w.title, w.type_of_activity, d.name as activity_type_val, w.type_of_activity_other,
