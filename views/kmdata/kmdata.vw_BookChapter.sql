CREATE OR REPLACE VIEW kmdata.vw_BookChapter AS 
 SELECT w.id, w.resource_id, w.user_id, w.author_list, w.city, w.country, w.edition, w.editor_list, w.percent_authorship, 
        ...
        w.author_list, w.city, w.country, w.edition, w.editor_list, w.percent_authorship, w.publication_dmy_single_date_id,
	          w.publisher, w.is_review, f.name as review_type, w.review_type_id, w.state, w.title, w.title_in, w.url, w.volume, w.work_type_id,
	          a.work_type_name, w.isbn, w.lccn,
	          w.beginning_page, w.ending_page, w.status_id, e.name as publication_status, w.book_author,
