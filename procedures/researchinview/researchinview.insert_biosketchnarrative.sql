CREATE OR REPLACE FUNCTION researchinview.insert_biosketchnarrative (
...
BEGIN
   ...
   v_ActivityID := researchinview.insert_activity('BiosketchNarrative', p_IntegrationActivityId, p_IntegrationUserId, p_IsPublic, p_ExtendedAttribute1,
   ...
   IF v_ResourceID IS NULL THEN
      ...
      v_NarrativeID := kmdata.add_new_narrative('researchinview', 'Biographical', researchinview.strip_riv_tags(p_NarrativeText), p_IsPublic);
