CREATE OR REPLACE FUNCTION researchinview.insert_continuingedcoursesnarrative (
...
BEGIN
   ...
   v_ActivityID := researchinview.insert_activity('ContinuingEdCoursesNarrative', p_IntegrationActivityId, p_IntegrationUserId, p_IsPublic, p_ExtendedAttribute1,
   ...
   IF v_ResourceID IS NULL THEN
      ...
      v_NarrativeID := kmdata.add_new_narrative('researchinview', 'Continuing Education, Extension, and Other Courses Taught', p_NarrativeText, p_IsPublic);
   ...
   ELSE
      ...
      UPDATE kmdata.narratives
         SET narrative_text = p_NarrativeText,
