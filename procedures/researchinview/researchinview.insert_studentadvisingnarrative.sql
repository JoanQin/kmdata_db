CREATE OR REPLACE FUNCTION researchinview.insert_studentadvisingnarrative (
...
BEGIN
   ...
   v_ActivityID := researchinview.insert_activity('StudentAdvisingNarrative', p_IntegrationActivityId, p_IntegrationUserId, p_IsPublic, p_ExtendedAttribute1,
   ...
   IF v_ResourceID IS NULL THEN
      ...
      v_NarrativeID := kmdata.add_new_narrative('researchinview', 'Academic Advising', p_NarrativeText, p_IsPublic);
