CREATE OR REPLACE FUNCTION researchinview.insert_undergraduatecoursesnarrative (
...
BEGIN
   ...
   v_ActivityID := researchinview.insert_activity('UndergraduateCoursesNarrative', p_IntegrationActivityId, p_IntegrationUserId, p_IsPublic, p_ExtendedAttribute1,
   ...
   IF v_ResourceID IS NULL THEN
      ...
      v_NarrativeID := kmdata.add_new_narrative('researchinview', 'Undergraduate, Graduate, and Professional Courses Taught', researchinview.strip_riv_tags(p_NarrativeText), p_IsPublic);
