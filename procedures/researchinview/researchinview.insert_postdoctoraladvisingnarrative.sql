CREATE OR REPLACE FUNCTION researchinview.insert_postdoctoraladvisingnarrative (
...
BEGIN
   ...
   v_ActivityID := researchinview.insert_activity('PostdoctoralAdvisingNarrative', p_IntegrationActivityId, p_IntegrationUserId, p_IsPublic, p_ExtendedAttribute1,
   ...
   IF v_ResourceID IS NULL THEN
      ...
      v_NarrativeID := kmdata.add_new_narrative('researchinview', 'Postdoctoral / Researcher Advising', p_NarrativeText, p_IsPublic);
