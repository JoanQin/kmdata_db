CREATE OR REPLACE FUNCTION researchinview.insert_noteworthyundergraduatenarrative (
...
BEGIN
   ...
   v_ActivityID := researchinview.insert_activity('NoteworthyUndergraduateNarrative', p_IntegrationActivityId, p_IntegrationUserId, p_IsPublic, p_ExtendedAttribute1,
   ...
   IF v_ResourceID IS NULL THEN
      ...
      v_NarrativeID := kmdata.add_new_narrative('researchinview', 'Advising Narrative', p_NarrativeText, p_IsPublic);
