...
select * from osupro.location_county_ref;

SELECT g.id, g.resource_id, g.title, g.url, n1.narrative_text AS description_text,
...
INNER JOIN kmdata.dmy_range_dates h ON g.outreach_dmy_range_date_id = h.id -- this and above is inner
